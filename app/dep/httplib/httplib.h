...
#define CPPHTTPLIB_CONNECTION_TIMEOUT_USECOND 3000000
#endif
...
inline Error wait_until_socket_is_ready(socket_t sock, time_t sec,
  ...
  if (poll_res == 0) {
      printf("wait_until_socket_is_ready 1111111111111");
  ...
  printf("wait_until_socket_is_ready 2222222222 aaaaaaaa\n");
  timeval tv;
  ...
  if (ret == 0) {
      printf("wait_until_socket_is_ready 2222222222: tv_sec %ld | tv_usec: %ld\n", tv.tv_sec, tv.tv_usec );
      return Error::ConnectionTimeout;
  }
