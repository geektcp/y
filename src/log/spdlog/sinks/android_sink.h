...
private:
    ...
    // __android_log_buf_write, if user explicitly provides a non-default spdlog buffer. Otherwise,
    // when using the default spdlog buffer, always spdlog via __android_log_write.
